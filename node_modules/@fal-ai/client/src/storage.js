 ...
 */
function initiateUpload(file, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield (0, request_1.dispatchRequest)({
            method: "POST",
            targetUrl: `${(0, config_1.getRestApiUrl)()}/storage/upload/initiate`,
            input: {
...
function createStorageClient({ config, }) {
    const ref = {
        upload: (file) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { upload_url: uploadUrl, file_url: url } = yield initiateUpload(file, config);
