...
export type FluxProRedux = {
     ...
     */
    image_size?: ImageSize | "square_hd" | "square" | "portrait_4_3" | "portrait_16_9" | "landscape_4_3" | "landscape_16_9";
    /**
...
export type AnyLlmVisionInput = {
     ...
     */
    model?: "anthropic/claude-3.5-sonnet" | "anthropic/claude-3-haiku" | "google/gemini-pro-1.5" | "google/gemini-flash-1.5" | "google/gemini-flash-1.5-8b" | "openai/gpt-4o";
    /**
...
export type DreamshaperImageToImageInput = {
     ...
     */
    model_name?: "Lykon/dreamshaper-xl-1-0" | "Lykon/dreamshaper-xl-v2-turbo" | "Lykon/dreamshaper-8";
    /**
     * The prompt to use for generating the image. Be as descriptive as possible for best results.
     */
    prompt: string;
...
export type FooocusImagePromptInput = {
     ...
     */
    inpaint_mode?: "Inpaint or Outpaint (default)" | "Improve Detail (face, hand, eyes, etc.)" | "Modify Content (add objects, change background, etc.)";
    /**
     ...
     */
    uov_method?: "Disabled" | "Vary (Subtle)" | "Vary (Strong)" | "Upscale (1.5x)" | "Upscale (2x)" | "Upscale (Fast 2x)";
    /**
...
export type IclightV2Input = {
    ...
    mask_image_url?: string | Blob | File;
    /**
     * Threshold for the background removal algorithm. A high threshold will produce sharper masks. Default value: `0.67`
     */
...
export type ImageToImageInput = {
     ...
     */
    scheduler?: "DPM++ 2M" | "DPM++ 2M Karras" | "DPM++ 2M SDE" | "DPM++ 2M SDE Karras" | "Euler" | "Euler A" | "Euler (trailing timesteps)" | "LCM" | "LCM (trailing timesteps)" | "DDIM" | "TCD";
    /**
...
export type IpAdapterFaceIdInput = {
     ...
     */
    model_type?: "1_5-v1" | "1_5-v1-plus" | "1_5-v2-plus" | "SDXL-v1" | "SDXL-v2-plus" | "1_5-auraface-v1";
    /**
     * The prompt to use for generating the image. Be as descriptive as possible for best results.
     */
    prompt: string;
...
export type KolorsImageToImageInput = {
     ...
     */
    scheduler?: "EulerDiscreteScheduler" | "EulerAncestralDiscreteScheduler" | "DPMSolverMultistepScheduler" | "DPMSolverMultistepScheduler_SDE_karras" | "UniPCMultistepScheduler" | "DEISMultistepScheduler";
    /**
     * The format of the generated image. Default value: `"png"`
     */
    output_format?: "jpeg" | "png";
...
export type LightningModelsImageToImageInput = {
     ...
     * Scheduler / sampler to use for the image denoising process.
     */
    scheduler?: "DPM++ 2M" | "DPM++ 2M Karras" | "DPM++ 2M SDE" | "DPM++ 2M SDE Karras" | "DPM++ SDE" | "DPM++ SDE Karras" | "KDPM 2A" | "Euler" | "Euler (trailing timesteps)" | "Euler A" | "LCM" | "EDMDPMSolverMultistepScheduler" | "TCDScheduler";
    /**
     * If set to true, the prompt will be expanded with additional prompts.
     */
    expand_prompt?: boolean;
...
export type PixartSigmaInput = {
     ...
     */
    style?: "(No style)" | "Cinematic" | "Photographic" | "Anime" | "Manga" | "Digital Art" | "Pixel art" | "Fantasy art" | "Neonpunk" | "3D Model";
    /**
     * The size of the generated image. Default value: `square_hd`
     */
    image_size?: ImageSize | "square_hd" | "square" | "portrait_4_3" | "portrait_16_9" | "landscape_4_3" | "landscape_16_9";
...
export type ResizeImageInput = {
     ...
     */
    cropping_position?: "center" | "top_left" | "top_right" | "bottom_left" | "bottom_right";
    /**
